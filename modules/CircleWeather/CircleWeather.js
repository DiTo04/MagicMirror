...
Module.register("CircleWeather",{
	...
	getDom: function() {
		...
		var large = document.createElement("tr");
		large.className = "large light";

		var weatherIcon = document.createElement("td");
		weatherIcon.id = "temprature";
		large.appendChild(weatherIcon);
		var circle = new circleDonutChart('temprature');
		Log.log("Temp: " + this.temperature);
		circle.draw({
			end: this.temperature,
			start:0, 
		...
		windIcon.id = "windIconId";
		large.appendChild(windIcon);
		var circle = new circleDonutChart('windIconId');
		Log.log("wind: " + this.windspeed);
		circle.draw({
			end: this.windSpeed,
			start:0, 
			maxValue:20, 
		...
		humidityIcon.id = "humidityID";
		large.appendChild(humidityIcon);
		var circle = new circleDonutChart('humidityID');
		Log.log("Temp: " + this.temperature);
		circle.draw({
			end: this.humidity,
			start:0, 
	...
	processWeather: function(data) {
		...
		Log.log("Windspeed: " +this.windspeed);
